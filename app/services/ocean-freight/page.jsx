...
export default function WarehousingPage() {
  ...
  <div className="absolute inset-0 w-full h-full">
    <Image
      src="/OceanFreight/oceanfreight.jpg"
  ...
  <div className="relative h-full flex items-center justify-center px-6 md:px-12 lg:px-24">
    <div className="max-w-4xl">
      ...
      <h1 className="text-4xl md:text-4xl lg:text-5xl  font-bold text-white mb-6 leading-[1.2] tracking-tight">
       Ocean Freight 
        <span className="space-x-2 text-amber-500 mt-2"> Simplified.</span>
      </h1>
      
      {/* Description with Better Readability */}
      <p className="text-gray-200 text-lg md:text-xl max-w-2xl leading-relaxed mb-8">
        Efficient, reliable, and well-coordinated ocean freight solutions
        <span className="block text-amber-400 text-center font-medium mt-2">
          tailored for global cargo movement.
        </span>
      </p>
    ...
    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
      ...
      >
        ...
        <p className="text-gray-600 text-lg leading-relaxed">
          Our warehousing solutions are designed to streamline your supply
          chain with efficiency and accuracy. We offer advanced inventory
          management, real-time tracking, and seamless integration.
        </p>

        {/* Feature List - Premium Details */}
        <div className="space-y-4 pt-4">
          {[
            { icon: "⚡", title: "Efficient Cargo Movement", desc: "Planned shipping with reliable scheduling and route coordination" },
            { icon: "🔒", title: "Secure Handling", desc: "Careful cargo management ensuring safety throughout transit" },
            { icon: "🤝", title: "Dedicated Support", desc: "Consistent assistance for smooth and hassle-free shipping processes" }
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      >
        <div className="relative h-[450px] md:h-[500px] lg:h-[550px] w-full rounded-md overflow-hidden shadow-2xl">
          {/* Main Image */}
          <Image
            src="/OceanFreight/oceanfreightandglobalshipping.jpg"
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
    ...
    >
      ...
      <p className="text-gray-600 text-lg max-w-2xl mx-auto">
        Choose from our ocean freight solutions designed to adapt to your cargo requirements and global shipping needs.
      </p>
    </motion.div>
        ...
        >
          <div className="relative bg-white rounded-md overflow-hidden  shadow-lg hover:shadow-xl  duration-500 h-full">
            ...
            <div className="relative h-64 overflow-hidden">
              <img
                src="/OceanFreight/techenabledsolution.jpg"
            ...
            <div className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-6 line-clamp-2">
                Efficient cargo movement through shared container solution to optimize cost and improve shipment efficiency.
              </p>
      ...
      <SwiperSlide>
        ...
        >
          <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl duration-500 h-full">
            <div className="relative h-64 overflow-hidden">
              <Image
                src="/OceanFreight/plannedshipping.jpg"
            ...
            <div className="p-8">
              <h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-amber-600 transition-colors duration-300">
                Planned Freight Solutions
              </h3>
              <p className="text-gray-600 leading-relaxed mb-6 line-clamp-2">
                Structured shipping with proper scheduling, route planning, and coordination for smooth global transportation.
              </p>
              <a 
                href="#" 
                className="inline-flex items-center gap-2 text-amber-600 font-semibold group/link hover:gap-3 transition-all duration-300"
      ...
      <SwiperSlide>
        ...
        >
          <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl  duration-500 h-full">
            <div className="relative h-64 overflow-hidden">
              <Image
                src="/OceanFreight/customisedshipping.jpg"
            ...
            <div className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-6 line-clamp-2">
                Flexible ocean freight services designed to meet specific cargo needs and varying international trade requirements.
              </p>
              <a 
                href="#" 
                className="inline-flex items-center gap-2 text-amber-600 font-semibold group/link hover:gap-3 transition-all duration-300"
    ...
    <div className="max-w-3xl mb-4">
      <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
        ...
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-700">
          Structured Shipping Practices
        </span>
      </h2>

      <p className="mt-6 text-lg text-gray-600 leading-relaxed">
        Our ocean freight services help improve shipment planning, reduce delays, and ensure consistent cargo movement with better coordination.
      </p>
    </div>
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        {[
          {
            ...
            desc: "Optimized shipping routes to improve transit efficiency and delivery timelines.",
            icon: "📊",
          },
          {
            title: "Cargo Coordination",
            desc: "Efficient handling and scheduling to ensure smooth cargo movement.",
            icon: "📦",
          },
          {
            title: "Shipment Monitoring",
            desc: "Regular tracking updates to maintain visibility across the shipping process.",
            icon: "🛡️",
          },
        ].map((item, i) => (
          <div
      ...
      <div className="relative group">
        ...
        <div className="relative rounded-md overflow-hidden border border-white/20 shadow-2xl">
          ...
          {/* Image */}
          <img
            src="/OceanFreight/Structuredshipping.jpg"
            alt="Team analytics"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 mt-4 max-w-xl mx-auto text-lg">
            Built for reliable coordination, shipment visibility, and smooth global cargo movement.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              desc: "Coordinated shipment handling with structured planning for efficient ocean freight execution.",
              stat: "45%",
              icon: (
                <path
                  strokeLinecap="round"
            ...
            },
            {
              ...
              desc: "Track shipments with consistent updates to ensure transparency across the shipping journey.",
              stat: "99.9%",
              icon: (
                <>
                  <path
            ...
            },
            {
              ...
              desc: "Proper handling of shipping documents to ensure smooth and compliant international movement.",
              stat: "100%",
              icon: (
                <>
                  <path
            ...
            },
            {
              ...
              desc: "Aligned communication with carriers and partners for reliable and timely shipment execution.",
              stat: "Real-time",
              icon: (
                <>
                  <path
            ...
            <SwiperSlide key={i}>
              ...
              >
                <div className="relative bg-white rounded-xl p-7 h-full border border-gray-200 shadow-md hover:shadow-xl flex flex-col justify-between overflow-hidden">
                  ...
                  {/* Content */}
                  <div>
                    <h3 className="text-xl font-bold line-clamp-1 text-gray-800 mb-3 group-hover:text-amber-600 transition-colors">
                      {item.title}
                    </h3>
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-10">
    ...
    <div className="text-center mb-20">
      ...
      <p className="text-gray-500 text-lg mt-4 max-w-2xl mx-auto leading-relaxed">
        Ensure consistent cargo movement, better planning, and improved control over international shipments with structured ocean freight services.
      </p>
    </div>
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center mb-14">
      ...
      <div>
        <div className="space-y-5">
          {[
            {
              title: "Improved Shipment Planning",
              desc: "Better coordination reduces delays and ensures timely cargo movement.",
              icon: "/offer/buss-warehouse-icon1.webp"
            },
            {
              title: "End-to-End Visibility",
              desc: "Clear tracking updates for better control across shipping stages.",
              icon: "/offer/buss-warehouse-icon2.webp"
            },
            {
              title: "Secure Cargo Handling",
              desc: "Careful management to maintain safety throughout transit.",
              icon: "/offer/buss-warehouse-icon3.webp"
            },
            {
              title: "Scalable Shipping Solutions",
              desc: "Flexible services designed to support growing business requirements.",
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="order-1 lg:order-2">
        ...
        <div className="space-y-4 text-gray-500 text-lg leading-relaxed">
          <p>
            Gain better visibility and control over your shipments with structured coordination and efficient freight management.
          </p>
          <p>
            Our approach ensures smooth cargo movement through proper planning, consistent updates, and reliable execution across global routes.
          </p>
        </div>

          ...
          <div className="relative h-full flex items-center justify-center px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-4xl lg:text-5xl  font-bold text-white mb-6 leading-[1.2] tracking-tight">
                Air Freight
                <span className=" text-amber-500 mt-2"> Simplified.</span>
              </h1>

              {/* Description with Better Readability */}
              <p className="text-gray-200 text-lg md:text-xl max-w-2xl leading-relaxed mb-8">
                Efficient, reliable, and well-coordinated air freight solutions
                <span className="block text-amber-400 sm:text-center text-start font-medium mt-2">
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  Our air freight services are designed to ensure fast and efficient cargo movement with minimal transit time. With strong coordination, priority handling, and reliable execution, we support time-sensitive shipments across domestic and international routes.
                </p>

                {/* Feature List - Premium Details */}
                <div className="space-y-4 pt-4">
                  {[
                    { icon: "⚡", title: "Priority Handling", desc: "Quick processing and fast movement for urgent shipments" },
                    { icon: "🔒", title: "Secure Transport", desc: "Careful cargo handling ensuring safety throughout transit" },
                    { icon: "🤝", title: "Dedicated Support", desc: "Consistent assistance for smooth and reliable air shipments" }
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
            ...
            >
              ...
              <h2 className="text-4xl md:text-4xl lg:text-5xl font-bold mb-4 leading-[1.2] tracking-tight">
                Flexible Air Freight
                <span className="block text-amber-600">Model</span>
              </h2>

              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Choose from our air freight solutions designed to meet urgent delivery timelines and dynamic shipment needs.
                ...
                >
                  <div className="relative bg-white rounded-md overflow-hidden  shadow-lg hover:shadow-xl  duration-500 h-full">
                    ...
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/AirFreight/techenabledsolution.jpg"
                    ...
                    <div className="p-8">
                      ...
                      >
                        Fast air cargo movement with quick handling and minimal transit time for time-sensitive deliveries.
                      </motion.p>
              ...
              <SwiperSlide>
                ...
                >
                  <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl duration-500 h-full">
                    <div className="relative h-64 overflow-hidden">
                      <img
                        src="/AirFreight/scheduledairservices.jpg"
                        alt="Centralised Network"
                    ...
                    <div className="p-8">
                      ...
                      >
                        Planned air shipments with structured coordination for reliable and timely cargo movement.
                      </motion.p>
              ...
              <SwiperSlide>
                ...
                >
                  <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl  duration-500 h-full">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/AirFreight/customisedairsolution.jpg"
                    ...
                    <div className="p-8">
                      ...
                      >
                        Flexible air freight services tailored to specific cargo types and varying delivery requirements.
                      </motion.p>
                      <button
                        onClick={() => setOpen(!open)}
                        className="inline-flex items-center gap-2 text-amber-600 font-semibold group/link hover:gap-3 transition-all duration-300"
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="max-w-3xl mb-4">
              ...
              <p className="mt-6 text-lg text-gray-600 leading-relaxed">
                Our air freight services help reduce transit time, improve coordination, and ensure reliable movement of urgent shipments.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                {[
                  {
                    ...
                    desc: "Efficient scheduling to meet strict delivery timelines.",
                    icon: "📊",
                  },
                  {
                    title: "Fast Cargo Handling",
                    desc: "Quick coordination ensuring smooth shipment movement.",
                    icon: "📦",
                  },
                  {
                    title: "Shipment Visibility",
                    desc: "Ensure product availability at the right time with automated replenishment systems.",
                    icon: "🛡️",
                  },
                ].map((item, i) => (
                  <div
              ...
              <div className="relative group">
                ...
                <div className="relative rounded-md overflow-hidden border border-white/20 shadow-2xl">
                  ...
                  {/* Image */}
                  <img
                    src="/AirFreight/fasterairdelivery.jpg"
                    alt="Team analytics"
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
            ...
            >
              ...
              <p className="text-gray-600 mt-4 max-w-xl mx-auto text-lg">
                Built for speed, accuracy, and reliable cargo movement across global air routes.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "Quick shipment handling with structured workflows for efficient air freight execution",
                  stat: "45%",
                  icon: (
                    <path
                      strokeLinecap="round"
                ...
                {
                  title: "Live Tracking",
                  desc: "Track shipments with real-time updates for better visibility and control.",
                  stat: "99.9%",
                  icon: (
                    <>
                      <path
                ...
                },
                {
                  ...
                  desc: "Accurate paperwork handling for smooth and compliant air shipments.",
                  stat: "100%",
                  icon: (
                    <>
                      <path
                ...
                {
                  title: "Vendor & POS",
                  desc: "Centralized vendor control with real-time POS synchronization.",
                  stat: "Real-time",
                  icon: (
                    <>
                      <path
                ...
                <SwiperSlide key={i}>
                  ...
                  >
                    <div className="relative bg-white rounded-xl p-7 h-full border border-gray-200 shadow-md hover:shadow-xl flex flex-col justify-between overflow-hidden">
                      ...
                      {/* Content */}
                      <div>
                        <h3 className="text-xl line-clamp-1 font-bold text-gray-800 mb-3 group-hover:text-amber-600 transition-colors">
                          {item.title}
                        </h3>
                        <motion.p
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-gray-500 text-lg mt-4 max-w-2xl mx-auto leading-relaxed">
                Ensure faster delivery, better coordination, and improved control over time-sensitive shipments.
              </p>
            </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Reduced transit time for urgent cargo movement.",
                      icon: "/offer/buss-warehouse-icon1.webp"
                    },
                    {
                      title: "End-to-End Visibility",
                      desc: "Clear tracking updates throughout the shipping process.",
                      icon: "/offer/buss-warehouse-icon2.webp"
                    },
                    {
                      title: "Secure Handling",
                      desc: "Safe and careful cargo management during transit.",
                      icon: "/offer/buss-warehouse-icon3.webp"
                    },
                    {
                      title: "Flexible Solutions",
                      desc: "Adaptable services for different shipment needs.",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-4 text-gray-500 text-lg leading-relaxed">
                  <p>
                    Gain better control over your air shipments with efficient coordination and fast execution.
                  </p>
                  <p>
                    Our approach ensures timely delivery through proper planning, continuous tracking, and reliable handling across air freight operations.
                  </p>
                </div>

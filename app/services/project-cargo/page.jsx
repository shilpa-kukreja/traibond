      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="relative h-[80vh] w-full overflow-hidden">
          ...
          <div className="absolute inset-0 w-full h-full">
            <Image
              src="/ProjectCargo/projectcargo.jpg"
          ...
          <div className="relative h-full flex items-center justify-center px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl">
              ...
              <p className="text-gray-200 text-lg md:text-xl max-w-2xl leading-relaxed mb-8">
                Specialized, planned, and well-coordinated logistics solutions
                <span className="block text-amber-400 text-center font-medium mt-2">
                  tailored for complex and oversized cargo movement.
                </span>
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  Our project cargo services are designed to manage complex and oversized shipments with precision. From route planning to execution, we ensure safe handling, proper coordination, and smooth transportation across domestic and international routes.
                </p>

                {/* Feature List - Premium Details */}
                <div className="space-y-4 pt-4">
                  {[
                    { icon: "⚡", title: "Route Planning", desc: "Detailed planning for safe and efficient cargo movement" },
                    { icon: "🔒", title: "Special Handling", desc: "Careful management of heavy and oversized shipments" },
                    { icon: "🤝", title: "Dedicated Support", desc: "Consistent assistance throughout the project lifecycle" }
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
            ...
            >
              ...
              <h2 className="text-4xl md:text-4xl lg:text-5xl font-bold mb-4 leading-[1.2] tracking-tight">
                Flexible Project Cargo
                <span className="block text-amber-600">Model</span>
              </h2>

              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Choose from our project cargo solutions designed to handle complex logistics and specialized requirements.
              </p>
            </motion.div>
                ...
                >
                  <div className="relative bg-white rounded-md overflow-hidden  shadow-lg hover:shadow-xl  duration-500 h-full">
                    ...
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/ProjectCargo/heavylifttransport.jpg"
                    ...
                    <div className="p-8">
                      ...
                      >
                        Efficient movement of oversized and heavy cargo with proper equipment and handling processes.
                      </motion.p>
              ...
              <SwiperSlide>
                ...
                >
                  <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl duration-500 h-full">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/ProjectCargo/routemanagement.jpg"
                    ...
                    <div className="p-8">
                      ...
                      >
                        Planned transportation with detailed route analysis to ensure smooth and safe cargo delivery.
                      </motion.p>
                      <button
                        onClick={() => setOpen(!open)}
                        className="inline-flex items-center gap-2 text-amber-600 font-semibold group/link hover:gap-3 transition-all duration-300"
              ...
              <SwiperSlide>
                ...
                >
                  <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl  duration-500 h-full">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/ProjectCargo/customisedsolutions.jpg"
                    ...
                    <div className="p-8">
                      ...
                      >
                        Tailored logistics services based on cargo size, type, and project-specific requirements.
                      </motion.p>
                      <button
                        onClick={() => setOpen(!open)}
                        className="inline-flex items-center gap-2 text-amber-600 font-semibold group/link hover:gap-3 transition-all duration-300"
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="max-w-3xl mb-4">
              ...
              <p className="mt-6 text-lg text-gray-600 leading-relaxed">
                Our project cargo services help improve coordination, reduce risks, and ensure smooth handling of complex shipments.
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    desc: "Detailed coordination for safe and timely delivery",
                    icon: "📊",
                  },
                  {
                    title: "Cargo Coordination",
                    desc: "Efficient handling across multiple transport stages",
                    icon: "📦",
                  },
                  {
                    title: "Progress Visibility",
                    desc: "Regular updates throughout the shipment process.",
                    icon: "🛡️",
                  },
                ].map((item, i) => (
                  <div
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
            ...
            >
              ...
              <p className="text-gray-600 mt-4 max-w-xl mx-auto text-lg">
                Built for precision, coordination, and safe handling of complex logistics movements
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "Detailed preparation for efficient cargo execution",
                  stat: "45%",
                  icon: (
                    <path
                      strokeLinecap="round"
                ...
                },
                {
                  ...
                  desc: "Continuous updates for better shipment visibility",
                  stat: "99.9%",
                  icon: (
                    <>
                      <path
                ...
                },
                {
                  ...
                  desc: "Accurate paperwork for smooth and compliant transport.",
                  stat: "100%",
                  icon: (
                    <>
                      <path
                ...
                },
                {
                  ...
                  desc: "Aligned communication across all involved parties",
                  stat: "Real-time",
                  icon: (
                    <>
                      <path
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-gray-500 text-lg mt-4 max-w-2xl mx-auto leading-relaxed">
                Ensure safe handling, proper planning, and smooth execution of complex and oversized shipments.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-14">
                  ...
                  {[
                    {
                      ...
                      desc: "Careful handling of heavy and sensitive cargo",
                      icon: "/offer/buss-warehouse-icon1.webp"
                    },
                    {
                      title: "Efficient Planning",
                      desc: "Structured execution to avoid delays and risks.",
                      icon: "/offer/buss-warehouse-icon2.webp"
                    },
                    {
                      title: "End-to-End Visibility",
                      desc: "Clear updates across every stage of movement",
                      icon: "/offer/buss-warehouse-icon3.webp"
                    },
                    {
                      title: "Customized Execution",
                      desc: "Solutions designed for project-specific requirements.",
              ...
              <div className="relative group">
                ...
                <div className="relative rounded-md overflow-hidden shadow-xl">
                  ...
                  <img
                    src="/ProjectCargo/cargoservices.jpg"
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative group order-2 lg:order-1">
                ...
                <div className="relative rounded-md overflow-hidden shadow-xl">
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/40 via-transparent to-transparent z-10" />
                  <img
                    src="/ProjectCargo/datatracking.jpg"
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-4 text-gray-500 text-lg leading-relaxed">
                  <p>
                    Gain better control over complex shipments with structured planning and coordinated execution.
                  </p>
                  <p>
                    Our approach ensures smooth project cargo movement through proper handling, route planning, and consistent monitoring.
                  </p>
                </div>

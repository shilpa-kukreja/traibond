      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="relative h-[80vh] w-full overflow-hidden">
          ...
          <div className="absolute inset-0 w-full h-full">
            <Image
              src="/CustomClearing/customclearance.jpg"
          ...
          <div className="relative h-full flex items-center justify-center px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl">
              ...
              <p className="text-gray-200 text-lg md:text-xl max-w-2xl leading-relaxed mb-8">
                Smooth, compliant, and efficient customs clearance solutions
                <span className="block text-amber-400 text-center font-medium mt-2">
                  tailored for seamless import and export operations.
                </span>
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  Our customs clearing services are designed to ensure smooth and hassle-free import and export processes. With proper documentation, regulatory compliance, and efficient coordination, we help reduce delays and keep your shipments moving without disruptions.
                </p>

                {/* Feature List - Premium Details */}
                <div className="space-y-4 pt-4">
                  {[
                    { icon: "⚡", title: "Accurate Documentation", desc: "Proper handling of paperwork to ensure smooth clearance" },
                    { icon: "🔒", title: "Regulatory Compliance", desc: "Adherence to customs rules for hassle-free operations" },
                    { icon: "🤝", title: "Dedicated Support", desc: "Personal account managers and 24/7 assistance" }
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
              ...
              >
                <div className="relative h-[450px] md:h-[500px] lg:h-[550px] w-full rounded-md overflow-hidden shadow-2xl">
                  {/* Main Image */}
                  <Image
                    src="/CustomClearing/customclearanceandcompliance.jpg"
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
            ...
            >
              ...
              <h2 className="text-4xl md:text-4xl lg:text-5xl font-bold mb-4 leading-[1.2] tracking-tight">
                Flexible Custom Clearing
                <span className="block text-amber-600">Model</span>
              </h2>

              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Choose from our customs clearance solutions designed to support different cargo types and trade requirements.
              </p>
            </motion.div>
                ...
                >
                  <div className="relative bg-white rounded-md overflow-hidden  shadow-lg hover:shadow-xl  duration-500 h-full">
                    ...
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/CustomClearing/techenabledsolution.jpg"
              ...
              <SwiperSlide>
                ...
                >
                  <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl duration-500 h-full">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/CustomClearing/exportclearance.jpg"
                    ...
                    <div className="p-8">
                      ...
                      >
                        Structured support for outbound shipments ensuring compliance and timely customs processing.
                      </motion.p>
              ...
              <SwiperSlide>
                ...
                >
                  <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl  duration-500 h-full">
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src="/CustomClearing/specializedhandling.jpg"
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="max-w-3xl mb-4">
              ...
              <p className="mt-6 text-lg text-gray-600 leading-relaxed">
                Our customs clearing services help reduce delays, improve coordination, and ensure faster movement of shipments across borders.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                {[
                  {
                    ...
                    desc: "Accurate preparation to avoid delays and errors.",
                    icon: "📊",
                  },
                  {
                    title: "Process Coordination",
                    desc: "Maintain optimal stock levels and eliminate overstocking or shortages.",
                    icon: "📦",
                  },
                  {
                    title: "Status Visibility",
                    desc: "Regular updates to track clearance progress.",
                    icon: "🛡️",
                  },
                ].map((item, i) => (
                  <div
              ...
              <div className="relative group">
                ...
                <div className="relative rounded-md overflow-hidden border border-white/20 shadow-2xl">
                  ...
                  {/* Image */}
                  <img
                    src="/CustomClearing/clearanceprocesses.jpg"
                    alt="Team analytics"
            ...
            >
              ...
              <h2 className="text-4xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent mt-2">
                  Custom Clearing Operations
                </span>
              </h2>

              <p className="text-gray-600 mt-4 max-w-xl mx-auto text-lg">
                Built for accuracy, compliance, and smooth processing of import and export shipments.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "Quick handling of documentation and clearance procedures.",
                  stat: "45%",
                  icon: (
                    <path
                      strokeLinecap="round"
                ...
                },
                {
                  ...
                  desc: "Ensuring adherence to all customs regulations and policies.",
                  stat: "99.9%",
                  icon: (
                    <>
                      <path
                ...
                },
                {
                  ...
                  desc: "Organized handling of required paperwork for smooth operations.",
                  stat: "100%",
                  icon: (
                    <>
                      <path
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-gray-500 text-lg mt-4 max-w-2xl mx-auto leading-relaxed">
                Ensure smooth import-export operations, reduced delays, and better control over customs processes.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-14">
                  ...
                  {[
                    {
                      ...
                      desc: "Reduced waiting time at customs checkpoints",
                      icon: "/offer/buss-warehouse-icon1.webp"
                    },
                    {
                      title: "Error-Free Documentation",
                      desc: "Accurate paperwork to avoid penalties and delays",
                      icon: "/offer/buss-warehouse-icon2.webp"
                    },
                    {
                      title: "Regulatory Compliance",
                      desc: "Proper adherence to all customs requirements",
                      icon: "/offer/buss-warehouse-icon3.webp"
                    },
                    {
                      title: "Efficient Processing",
                      desc: "Streamlined handling for smooth cargo movement",
              ...
              <div className="relative group">
                ...
                <div className="relative rounded-md overflow-hidden shadow-xl">
                  ...
                  <img
                    src="/CustomClearing/customclearanceservices.jpg"
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative group order-2 lg:order-1">
                ...
                <div className="relative rounded-md overflow-hidden shadow-xl">
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/40 via-transparent to-transparent z-10" />
                  <img
                    src="/CustomClearing/process.jpg"
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-4 text-gray-500 text-lg leading-relaxed">
                  <p>
                    Gain better control over your customs processes with efficient coordination and structured handling.
                  </p>
                  <p>
                    Our approach ensures smooth clearance through proper documentation, compliance management, and consistent tracking of shipment status.
                  </p>
                </div>
